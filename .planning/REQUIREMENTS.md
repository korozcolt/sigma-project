...
- [x] **CAMP-01**: Super admin can select an active campaign context explicitly and see which campaign context is currently active
- [x] **CAMP-02**: Campaign-scoped users can only view data that belongs to their active campaign across tables, widgets, dashboards, and detail pages
- [x] **CAMP-03**: Campaign-scoped users can only create, update, import, export, message, validate, or trigger workflows within their active campaign
- [x] **CAMP-04**: Campaign records capture election scope and territory rules needed to operate municipal, departmental, and national campaigns safely
...
- [x] **PERM-01**: Admins, coordinators, leaders, reviewers, and super admins each see only the panels, actions, and records that match their role
...
- [x] **VOTE-01**: Operator can create or import voters into the active campaign without cross-campaign contamination
- [x] **VOTE-02**: Operator can assign voters to the correct territorial structure and responsible role within the active campaign
...
- [x] **VOTE-05**: Voter status remains consistent across imports, validation, surveys, calls, messages, dashboards, and Day D workflows
...
- [x] **OUTR-02**: Call outcomes update follow-up state in a way that is traceable to the assignment and contact attempt
- [x] **OUTR-03**: Survey responses remain linked to the outreach attempt or call context that produced them
...
- [x] **REPT-01**: Dashboards, widgets, filters, and exports show counts that reconcile to campaign-scoped source records
...
- [x] **DAYD-01**: Operator can find the correct voter quickly within the active campaign during election-day operations
- [x] **DAYD-02**: Operator can mark vote status with required evidence rules enforced for "voted" outcomes
...
- [x] **DAYD-05**: Election-day actions and evidence are stored with audit-ready metadata tied to campaign, actor, time, and event
...
**Reconciled 2026-07-23** against a full codebase audit — see `.planning/phases/05.1-cross-phase-hardening-closure/05.1-CONTEXT.md` for per-requirement evidence. Phases 1-5's roadmap status was stale; most requirements were already substantially satisfied via inserted phases 02.1/04.1 plus incidental work. All remaining gaps closed in Phase 05.1 (2026-07-24) — all 30 v1 requirements are now Done.
...
| CAMP-05 | Phase 1 | Done (closed in Phase 05.1) |
| PERM-01 | Phase 1 | Done |
| PERM-02 | Phase 1 | Done (closed in Phase 05.1) |
| PERM-03 | Phase 1 | Done (closed in Phase 05.1) |
| VOTE-01 | Phase 2 | Done |
| VOTE-02 | Phase 2 | Done |
| VOTE-03 | Phase 2 | Done (closed in Phase 05.1) |
| VOTE-04 | Phase 2 | Done (closed in Phase 05.1) |
| VOTE-05 | Phase 2 | Done |
| VOTE-06 | Phase 2 | Done (closed in Phase 05.1) |
| OUTR-01 | Phase 3 | Done (closed in Phase 05.1) |
| OUTR-02 | Phase 3 | Done |
| OUTR-03 | Phase 3 | Done |
| OUTR-04 | Phase 3 | Done (closed in Phase 05.1 — live bug confirmed and fixed 2026-07-23) |
| OUTR-05 | Phase 3 | Done (closed in Phase 05.1) |
| REPT-01 | Phase 4 | Done |
| REPT-02 | Phase 4 | Done (closed in Phase 05.1, plan 07) |
| REPT-03 | Phase 4 | Done (closed in Phase 05.1 — was the biggest Phase 4 gap) |
...
- Mapped to phases: 30
- Unmapped: 0
- Done: 30 | Partial: 0 | Not covered: 0

---
*Requirements defined: 2026-03-25*
*Milestone v1.0 requirements closed: 2026-07-24 (Phase 05.1 verification, 22/22 must-haves)*
